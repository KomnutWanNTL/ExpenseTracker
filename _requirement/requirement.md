...
**FR-05** ระบบต้องจดจำการแก้ไขหมวดหมู่ของรายการที่ผู้ใช้เปลี่ยนแปลง เช่น หากผู้ใช้กรอก "airportlink" แล้วระบบใส่ "อื่น ๆ" แต่ผู้ใช้แก้เป็น "ขนส่ง" ครั้งถัดไปที่กรอก "airportlink" ระบบต้องเลือก "ขนส่ง" ให้โดยอัตโนมัติ

### ตัวอย่าง
1. กรอก "airportlink" ระบบใส่ "อื่น ๆ"
2. ผู้ใช้แก้ไขเป็น "ขนส่ง"
3. ครั้งถัดไปที่กรอก "airportlink" ระบบเลือก "ขนส่ง" ให้ทันที
